            ...
            <div className="cu-hd">
               <main>
                    <div className="cu-blk1">
                        ...
                        <p>6 durusonmi-etti, lekki </p>
                        <p> Lagos, Nigeria</p>
                    </div>
                    <div className="cu-blk2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="52" height="51" viewBox="0 0 52 51" fill="none">
               ...
               <aside>
                    <p className="cu-p1">Just Say Hello!</p>
                    <p className="cu-p2">Do you fancy saying hi to me or you want to get started with your project and you need my help? Feel free to contact me.</p>
                    <form>
                    <div className="form-div1">
                    <input className="inp1" type="text" placeholder="Template Cookie" />
                    <input className="inp2" type="text" placeholder="example@gmail.com" />
                    </div>
                    
                    <input className="inp3" type="text" placeholder="Hello..." />
                    
                    <input className="inp4" type="ma" placeholder="Subjects" />
                    <br/>
