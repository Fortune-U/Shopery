...
export default function (props) {
    ...
    const handleClick1 = () => {
        ...
        fetch(`https://shopery.onrender.com/api/v1/cart/add/${props.prod.id}`, {
        method: 'POST',
        credentials: 'include',
        headers: {
            ...
            <div className='row3'>
                <div className="prod-info">
                    ...
                    <div className='attributes'>
                        ...
                        <p>{props.prod.productStock}</p>
                    </div>
                    <div className='prod-price'>   
                    <div>
                        <p className='old-price'>{}</p> 
                        <p className='new-price'> <b>N</b>{props.prod.productPrice}</p>
                        </div>
                        <p className='discount-price'>-{props.prod.productDiscount}% Off</p>
                    </div>
                    <div className='socials'>
                        <div>
                        <p className='brand'>Weight: {props.prod.productWeight} gram</p>
                        {/* <img src={} alt="" /> */}
                        </div>
                    ...
                    <div className='cart-funcs'>
                        ...
                        <div className='cart-btn-ctn'>
                            <button className='add-to-cart' onClick={handleClick1}>Add to Cart
