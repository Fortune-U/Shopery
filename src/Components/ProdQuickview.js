            ...
            <div className='row3'>
                <div className="prod-info">
                    <div className='title-blk'>
                        <p className='title-name'>Chinese cabbage</p>
                    ...
                    <div>
                        <p className='old-price'>$48.00</p> 
                        <p className='new-price'> $17.28</p>
                        </div>
                        <p className='discount-price'>-64% Off</p>
                    </div>
                    ...
                    <p className='desc-text'>lorem ipsum dolor blah bklah aushidbfbufbidvkdivbuihisvnaovhvivnoidv nsdioegeghrhyrhgerdygdugudghdj</p>
