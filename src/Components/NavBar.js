    ...
    {!hideNavbar && (
            <div className="second-layer">
                <div className="second-layer-one">
                    ...
                    <p className="secondlayer-logo-txt">Eko-baazar</p>
                </div>
            ...
            <div className='sc-header'>
                ...
                <svg onClick={closeModal} xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
            ...
            <Link to="/cart"><button className='sc-check' onClick={closeModal}>Checkout</button></Link>
            <Link to="/cart">  <button className='sc-gtc' onClick={closeModal}>Go to Cart</button></Link>
            </div>
            </div>
            </div>
